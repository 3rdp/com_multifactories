 ...
 * @subpackage  multifactory
 *
 */
defined('_JEXEC') or die;

/**
 * Multifactory controller class.
 *
 * @since  1.6
 */
class MultifactoriesControllerMultifactory extends JControllerForm{
   ...
   *
   * @return  MultifactoriesModelMultifactory  The model.
   *
   */
  public function getModel($name = 'Multifactory', $prefix = 'MultifactoriesModel', $config = array('ignore_request' => true)){
    if (empty($name)){
      $name = $this->context;
    }
