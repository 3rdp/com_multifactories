 ...
 * @since  1.6
 */
class MultifactoriesControllerCities extends JControllerAdmin{
  /**
	 ...
	 * @since  1.6
	 */
	protected $text_prefix = 'COM_MULTIFACTORIES_CITIES';
  /**
   * Constructor.
   *
   ...
   *
   * @return  MultifactoriesModelCity The model.
   *
   * @since   12.2
   */
  public function getModel($name = 'City', $prefix = 'MultifactoriesModel', $config = array('ignore_request' => true)){
    if (empty($name)){
      $name = $this->context;
    }
