...
if ($saveOrder){
	$saveOrderingUrl = 'index.php?option=com_multifactories&task=crudfactories.saveOrderAjax&tmpl=component';
			...
			<table class="table table-striped" id="articleList">
				<thead>
					<tr>
						...
						<?php echo JHtml::_('searchtools.sort', 'COM_MULTIFACTORIES_HEADING_NAME', 'a.name', $listDirn, $listOrder); ?>
							
						</th>
						<th class="nowrap center">
						<?php echo JHtml::_('searchtools.sort', 'COM_MULTIFACTORIES_HEADING_ALIAS', 'a.alias', $listDirn, $listOrder); ?>
